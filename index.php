...
//=== MainMenuDiv =======================================================================
//echo '<div id="MainMenuDiv" > </ul>';
echo '<div class="col-sm-3 col-md-2 sidebar">
<ul class="nav nav-sidebar">'; //===HJ===
$i=0;
...
echo '<div id="TransactionsDiv" class="col-sm-4 col-md-4"><ul>'; //=== TransactionsDiv ===
...
echo '<div id="InquiriesDiv" class="col-sm-4 col-md-4"><ul>'; //=== InquiriesDiv ===
...
echo '<div id="MaintenanceDiv" class="col-sm-4 col-md-4"><ul>'; //=== MaintenanceDive ===
